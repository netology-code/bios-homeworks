...
Для выполнения домашнего задания скачайте [приложенный файл](https://github.com/netology-code/bios-homeworks/blob/master/4.3/DZ4_3.playground.zip) и следуйте инструкциям в самом файле.
